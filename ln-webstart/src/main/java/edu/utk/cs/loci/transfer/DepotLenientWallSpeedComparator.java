 ...
 * Window - Preferences - Java - Code Style - Code Templates
 */
public class DepotLenientWallSpeedComparator implements Comparator<DepotScore>
{
    public static Log DEBUG = new Log( true );

    public static final DepotLenientWallSpeedComparator singleton = new DepotLenientWallSpeedComparator();
    ...
    public int compare(DepotScore o1, DepotScore o2)
    {
        ...
        if ( (wSpeed1 == wSpeed2)
            || ((wSpeed1 == 0) || Double.isNaN( wSpeed1 )
                && !ts1.isLastTimeFailed())
            || ((wSpeed2 == 0) || Double.isNaN( wSpeed2 )
