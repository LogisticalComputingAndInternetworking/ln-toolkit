...
import edu.utk.cs.loci.transfer.ThreadStatusListDisplay;
import edu.utk.cs.loci.transfer.TransferStat;
import edu.utk.cs.loci.transfer.TransferStatListDisplay;
...
public class ProgressDialog extends JDialog implements ProgressListener
{
    ...
    public ProgressDialog( Exnode exnode, CountDownLatch allDoneBarrier )
    {
        ...
        Map<String, TransferStat> depotStats = scoreboard.getDepotStats();
