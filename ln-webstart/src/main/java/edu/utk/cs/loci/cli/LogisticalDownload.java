...
import edu.utk.cs.loci.exnode.NullSyncFile;
import edu.utk.cs.loci.exnode.PhysicalSyncFile;
import edu.utk.cs.loci.exnode.Progress;
import edu.utk.cs.loci.exnode.ProgressDialog;
import edu.utk.cs.loci.exnode.ReadJob;
import edu.utk.cs.loci.exnode.SyncFile;
...
public class LogisticalDownload
{
    ...
    private void printScoreboard()
    {
        ...
        Collection<DepotScore> c = scoreboard.getDepotScores();
        for ( Iterator<DepotScore> i = c.iterator(); i.hasNext(); )
        {
