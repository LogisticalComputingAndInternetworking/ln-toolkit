...
import edu.utk.cs.loci.transfer.AdaptiveDepotNiceLastSpeedComparator;
...
public class ReadJob implements Job
{
    ...
    public static Comparator<DepotScore> comparator
    ...
    private List<Mapping> untriedMappings;
    private List<Mapping> triedMappings;
        ...
        long baseOffset )
    {
        ...
        this.triedMappings = new ArrayList<Mapping>();
        this.buf = buf;
    }
    ...
    public List<Mapping> getContainingMappings( boolean randomized )
    {
        List<Mapping> mappings = exnode.getContainingMappings( offset, length );
    ...
    public int compareDepotScores( DepotScore ds1, DepotScore ds2 )
    {
        ...
        return ReadJob.comparator.compare( ds1, ds2 );
    }
    ...
    private synchronized Mapping findAndTryBestMapping()
    {
        ...
        synchronized ( ReadJob.scoreboard )
        {
            ...
            for ( int i = 1; i < this.untriedMappings.size(); i++ )
            {
                ...
                DepotScore depotScore = ReadJob.scoreboard.findDepotScore( depot );
            ...
            if ( bestThreadCount >= ReadJob.MAX_DEPOT_THREADS )
            {
    ...
    protected synchronized DoubleSpeedMeter startTry( Mapping m )
    {
        ...
        ReadJob.scoreboard.startTry( depot, (double) this.length );
        speedMeter.start();
        return speedMeter;
    }
        ...
        DoubleSpeedMeter speedMeter )
    {
        ...
        ReadJob.scoreboard.endSuccessfulTry(
        ...
        ReadJob.displayDepotStat( ReadJob.scoreboard.findDepotScore( depot ).getDepotStat() );
    }
        ...
        DoubleSpeedMeter speedMeter )
    {
        ...
        // if the same as the ReadJob length
        speedMeter.stop();
        ReadJob.scoreboard.endFailedTry( depot );
    ...
    /* (non-Javadoc)
	 * @see edu.utk.cs.loci.exnode.Job#execute()
	 */
    @Override
	public void execute()
    {
