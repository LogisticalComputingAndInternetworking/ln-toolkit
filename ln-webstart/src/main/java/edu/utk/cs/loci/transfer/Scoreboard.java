...
{
    protected Map<String, DepotScore> depotScores = new HashMap<String, DepotScore>();
    protected Map<String, TransferStat> depotStats = new HashMap<String, TransferStat>();
    protected Map<String, TransferStat> hostStats = new HashMap<String, TransferStat>();

    /**
     * @return Returns the depotStats.
     */
    public Map<String, TransferStat> getDepotStats()
    {
     ...
     */
    public Map<String, TransferStat> getHostStats()
    {
    ...
    protected String getDepotKey( Depot depot )
    {
        return depot.getHost() + ":" + depot.getPort();
    }

    protected String getHostKey( Depot depot )
    {
    ...
    protected DepotScore addNewDepot( Depot depot )
    {
        ...
        String depotKey = this.getDepotKey( depot );
    ...
    public synchronized Collection<DepotScore> getDepotScores()
    {
